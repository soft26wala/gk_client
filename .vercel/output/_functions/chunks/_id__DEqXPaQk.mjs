...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const metaDescription = post.data.contents[0] || `Read ${post.data.title} on ScrewFast's blog`;
...
}, "C:/myProject/G K Enterprise/client/src/pages/blog/[id].astro", void 0);

const $$file = "C:/myProject/G K Enterprise/client/src/pages/blog/[id].astro";
const $$url = "/blog/[id]";
