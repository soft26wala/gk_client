...
const file = "C:/myProject/G K Enterprise/client/src/content/docs/welcome-to-docs.mdx";
...
Content.moduleId = "C:/myProject/G K Enterprise/client/src/content/docs/welcome-to-docs.mdx";
