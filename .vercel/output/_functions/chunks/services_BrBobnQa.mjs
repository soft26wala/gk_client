...
const $$Services = createComponent(($$result, $$props, $$slots) => {
  ...
  const metaDescription = "Uniting expertise with your vision, ScrewFast provides exceptional service and comprehensive solutions in the hardware and construction industry, from consultation to project completion.";
...
}, "C:/myProject/G K Enterprise/client/src/pages/services.astro", void 0);

const $$file = "C:/myProject/G K Enterprise/client/src/pages/services.astro";
const $$url = "/services";
