import { g as getImage } from './_astro_assets_m5DGn2Iu.mjs';
import { i as icon } from './icon_BrMo3VVR.mjs';
...
const maskableIcon = new Proxy({"src":"/_astro/icon-maskable.C1A7b-dw.png","width":1024,"height":1024,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/myProject/G K Enterprise/client/src/images/icon-maskable.png";
							}
